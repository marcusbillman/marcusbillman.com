...
export default function Phone({
  ...
  return transparent ? (
    <svg
      ...
      className={className}
    >
      <path d="M23 52.5H26V91.5H23V52.5Z" fill="#3551B6" />
      <path d="M46 52.5H49V91.5H46V52.5Z" fill="#3551B6" />
      <path d="M91 52.5H94V91.5H91V52.5Z" fill="#3551B6" />
      <path d="M69 0.5H72V91.5H69V0.5Z" fill="#3551B6" />
      <path d="M114 52.5H117V91.5H114V52.5Z" fill="#3551B6" />
      <path d="M137 52.5H140V91.5H137V52.5Z" fill="#3551B6" />
      <path
    ...
    >
      <rect
        ...
        fill="white"
      />
      <path d="M23.6629 52.5H26.6629V91.5H23.6629V52.5Z" fill="#3551B6" />
      <path d="M46.6629 52.5H49.6629V91.5H46.6629V52.5Z" fill="#3551B6" />
      <path d="M91.6629 52.5H94.6629V91.5H91.6629V52.5Z" fill="#3551B6" />
      <path d="M69.6629 0.5H72.6629V91.5H69.6629V0.5Z" fill="#3551B6" />
      <path d="M114.663 52.5H117.663V91.5H114.663V52.5Z" fill="#3551B6" />
      <path d="M137.663 52.5H140.663V91.5H137.663V52.5Z" fill="#3551B6" />
      <path
