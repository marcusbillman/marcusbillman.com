...
export default function Knob({ transparent = false, className }: Props) {
  return transparent ? (
    <svg
      width="67"
      height="78"
      ...
      className={className}
    >
      <rect x="7" y="64" width="20" height="3" fill="#3551B6" />
      <rect x="31" y="64" width="30" height="3" fill="#3551B6" />
      <path
      ...
      <path
        ...
        strokeWidth="3"
      />
      <path d="M35 29L42 15" stroke="#3551B6" strokeWidth="3" />
      <circle cx="33.5" cy="33.5" r="21" stroke="#4265E3" strokeWidth="3" />
    </svg>
  ) : (
    <svg
      width="68"
    ...
    >
      ...
      />
      <path d="M35 29L42 15" stroke="#3551B6" strokeWidth="3" />
      <rect x="0.249969" y="57.5" width="67" height="16" rx="8" fill="white" />
      <rect x="7" y="64" width="20" height="3" fill="#3551B6" />
      <rect x="31" y="64" width="30" height="3" fill="#3551B6" />
    </svg>
  );
