...
export default function Daw({ transparent = false, className }: Props) {
  return transparent ? (
    <svg
      width="219"
      height="115"
    ...
    >
      ...
      <path
        ...
        fill="#4265E3"
      />
      <circle cx="5.5" cy="69.5" r="3.5" stroke="#3551B6" strokeWidth="3" />
      <circle cx="109.5" cy="93.5" r="3.5" stroke="#3551B6" strokeWidth="3" />
      <circle cx="150.5" cy="69.5" r="3.5" stroke="#3551B6" strokeWidth="3" />
      <circle cx="213.5" cy="81.5" r="3.5" stroke="#3551B6" strokeWidth="3" />
      <rect
        x="1.5"
        y="23"
        width="216"
        ...
        strokeWidth="3"
      />
      <rect x="6.5" y="27.5" width="25" height="3" fill="#3551B6" />
      <rect x="33.837" y="32.5" width="22" height="3" fill="#3551B6" />
      <rect x="62.837" y="37.5" width="38" height="3" fill="#3551B6" />
      <rect x="102.5" y="32.5" width="10" height="3" fill="#3551B6" />
      <rect x="114.5" y="47.5" width="10" height="3" fill="#3551B6" />
      <rect x="126.5" y="42.5" width="10" height="3" fill="#3551B6" />
      <rect x="138.5" y="37.5" width="10" height="3" fill="#3551B6" />
      <rect x="150.5" y="32.5" width="25" height="3" fill="#3551B6" />
      <rect x="177.5" y="37.5" width="35" height="3" fill="#3551B6" />
      <path
        d="M59.5 12.5V102.5"
        stroke="#3551B6"
        strokeWidth="3"
    ...
    <svg
      ...
      className={className}
    >
      <rect x="15" y="5.5" width="189" height="109" rx="8" fill="white" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M53.7664 5.5L55.4985 8.5H23C20.2386 8.5 18 10.7386 18 13.5V21.5H15V13.5C15 9.08172 18.5817 5.5 23 5.5H53.7664ZM15 56.5V68.0652C16.0068 68.0801 17.0067 68.0979 18 68.1188V56.5H15ZM201 56.5V77.5921L204 78.1636V56.5H201ZM204 21.5V13.5C204 9.08172 200.418 5.5 196 5.5H65.3134L63.5814 8.5H196C198.761 8.5 201 10.7386 201 13.5V21.5H204ZM18 71.1195C17.0071 71.0985 16.0072 71.0806 15 71.0656V106.5C15 110.918 18.5817 114.5 23 114.5H196C200.418 114.5 204 110.918 204 106.5V81.2175L201 80.6461V106.5C201 109.261 198.761 111.5 196 111.5H23C20.2386 111.5 18 109.261 18 106.5V71.1195Z"
      ...
      <circle
        ...
        strokeWidth="3"
      />
      <rect y="21.5" width="219" height="35" rx="4" fill="white" />
      <rect
        x="1.5"
        y="23"
        width="216"
