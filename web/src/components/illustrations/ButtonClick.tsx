...
export default function ButtonClick({ transparent = false, className }: Props) {
  return transparent ? (
    <svg
      width="133"
      height="62"
      ...
      className={className}
    >
      <rect x="72" y="16" width="12" height="3" fill="#3551B6" />
      <rect x="38" y="16" width="30" height="3" fill="#3551B6" />
      <line
        x1="19.1415"
        y1="21.5053"
        x2="28.5054"
    ...
    <svg
      ...
      className={className}
    >
      <rect x="2" y="1.5" width="107" height="30" rx="4" fill="white" />
      <rect x="71.6188" y="16" width="12" height="3" fill="#3551B6" />
      <rect x="37.6188" y="16" width="30" height="3" fill="#3551B6" />
      <line
        x1="18.7603"
        y1="21.5053"
        x2="28.1242"
